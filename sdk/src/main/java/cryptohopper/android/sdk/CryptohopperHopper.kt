...
import cryptohopper.android.sdk.API.Hopper.Position.ReleaseReservePosition.HopperAPIReleaseReservedPositionRequest
...
class CryptohopperHopper {
    ...
    companion object {
        ...
        fun getAllHoppers(
            name: String?,
            exchange: HopperConfigExchange?,
            enabled: Int?,
            callback: (List<Hopper>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetAllHoppersRequest(
                name,
                exchange,
                enabled
            ).request<HopperAPIGetAllHoppersResponse>({ hoppers ->
       ...
       fun getHopperIPWhitelist(hopperId: Int,exchange: String, callback: (CHIPWhitelist?, HopperAPIError?) -> Unit) {
        ...
        fun createHopper(
            ...
            callback: (HopperAPICreateHopperModel?, HopperAPIError?) -> Unit
        ) {
            HopperAPICreateHopperRequest(
                name,
                enabled,
                templateId,
                apiConfig,
                config
            ).request<HopperAPICreateHopperResponse>({ message ->
        ...
        fun updateHopper(
            ...
            name: String?,
            enabled: Int?,
            apiConfig: HopperConfigAPIConfig?,
            config: HopperConfig?,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIUpdateHopperRequest(
                hopperId,
                name,
                enabled,
                apiConfig
            ).request<HopperCommonMessageResponse>({ message ->
                callback(message.data, null)
            }, { error ->
                callback(null, error)
            })
        ...
        fun changeHopperImage(
            hopperId: String,
            image: String,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIChangeHopperImageRequest(hopperId, image).request<HopperCommonMessageResponse>(
                { message ->
                    callback(message.data, null)
                },
                { error ->
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper id
        fun disableHopperPapertrading(
            hopperId: String,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIDisableHopperPapertradingRequest(hopperId).request<HopperCommonMessageResponse>(
                { message ->
                    callback(message.data, null)
                },
                { error ->
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper id
        fun enableHopperPapertrading(
            hopperId: String,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIEnableHopperPapertradingRequest(hopperId).request<HopperCommonMessageResponse>(
                { message ->
                    callback(message.data, null)
                },
                { error ->
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper id
        fun getHopperMostTradedCurrency(
            hopperId: String,
            callback: (List<HopperMostTradedModel>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIHopperMostTradedCurrencyRequest(hopperId).request<HopperAPIHopperMostTradedCurrencyResponse>(
                { message ->
                    callback(message.data, null)
                },
                { error ->
        ...
        fun getAllOpenOrders(
            hopperId: String,
            callback: (List<HopperOrder>?, HopperAPIError?) -> Unit
        ) {
        ...
        fun getOneOpenOrder(
            hopperId: String,
            orderId: String,
            callback: (HopperOrder?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetOneOpenOrderRequest(
                hopperId,
                orderId
            ).request<HopperAPIGetOneOpenOrderResponse>({ data ->
                callback(data.data, null)
            }, { error ->
                callback(null, error)
            })
        ...
        fun createOrder(
            ...
            amount: Double,
            orderTrigger: String,
            percentageProfit: Double,
            trailingBuy: Double,
            trailingBuyPercentage: Double,
            stopLossPercentage: Double,
            trailingStopLossPercentage: Double,
            trailingArmPercentage: Double,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPICreateOrderRequest(
                hopperId,
                orderType,
                marketOrder,
                coin,
        ...
        fun deleteMultipleOrders(
            hopperId: String,
            orderIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIDeleteMultipleOrdersRequest(
                hopperId,
                orderIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun deleteMultipleOrders(
            ...
            HopperAPIDeleteOneOrderRequest(
                hopperId,
                orderId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun cancelTsbOrder(
            ...
            HopperAPICancelTSBOrderRequest(
                hopperId,
                orderId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun depositPapertradingAccount(
            hopperId: String,
            coin: String,
            amount: Double,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIPapertradingDepositRequest(
                hopperId,
                coin,
                amount
            ).request<HopperCommonMessageResponse>({ data ->
        ...
        /// - Parameter coin:  (required) Coin example: BTC
        /// - Parameter amount:  (required) Deposit Amount
        fun withdrawPapertradingAccount(
            hopperId: String,
            coin: String,
            amount: Double,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIPapertradingWithdrawRequest(
                hopperId,
                coin,
                amount
            ).request<HopperCommonMessageResponse>({ data ->
        ...
        fun deleteMultipleShortPositions(
            hopperId: String,
            positionIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIDeleteMultipleShortPositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun deleteOneShortPosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIDeleteOneShortPositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionIds:  (required) Position Ids as int array
        fun closeMultipleShortPositions(
            hopperId: String,
            positionIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPICloseMultipleShortPositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionId:  (required) Position Id
        fun closeOneShortPositions(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPICloseOneShortPositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun getAllPositions(
            hopperId: String,
            callback: (List<HopperPosition>?, HopperAPIError?) -> Unit
        ) {
        ...
        fun getOnePosition(
            hopperId: String,
            positionId: Int,
            callback: (HopperPosition?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetOnePositionRequest(
                hopperId,
                positionId
            ).request<HopperAPIGetOnePositionResponse>({ data ->
                callback(data.data, null)
            }, { error ->
                callback(null, error)
            })
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun getUnsyncedPositions(
            hopperId: String,
            callback: (HopperAPIGetUnsyncedPositionResponseData?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetUnsyncedPositionRequest(hopperId).request<HopperAPIGetUnsyncedPositionResponse>(
                { data ->
                    callback(data.data, null)
                },
                { error ->
        ...
        fun editStartBalance(
            hopperId: String,
            balance: Double,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIEditStartBalanceRequest(
                hopperId,
                balance
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun holdShortPosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIHoldShortPositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun holdOnePosition(
            ...
            HopperAPIHoldOnePositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun mergePositions(
            ...
            HopperAPIMergePositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionIds:  (required) Position Ids
        fun releaseMultiplePositions(
            hopperId: String,
            positionIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIReleaseMultiplePositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionId:  (required) Position Id
        fun releaseOnePosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIReleaseOnePositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionId:  (required) Position Id
        fun releaseShortPosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIReleaseShortPositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionId:  (required) Position Id
        fun releaseReservedPosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIReleaseReservedPositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionIds:  (required) Position Ids
        fun removeMultiplePositions(
            hopperId: String,
            positionIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIRemoveMultiplePositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun removeOnePosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIRemoveOnePositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun deletePosition(
            ...
            HopperAPIDeletePositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun takeProfit(
            ...
            HopperAPIPositionsTakeProfitRequest(
                hopperId,
                positionIds,
                percentage
            ).request<HopperCommonMessageResponse>({ data ->
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionIds:  (required) Position Ids
        fun splitMultiplePositions(
            hopperId: String,
            positionIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPISplitMultiplePositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun getShortPositions(
            hopperId: String,
            callback: (List<HopperShortPosition>?, HopperAPIError?) -> Unit
        ) {
        ...
        fun getAssets(
            ...
            HopperAPIGetAssetsRequest(
                hopperId,
                reserved
            ).request<HopperAPIGetAssetsResponse>({ data ->
                callback(data.data, null)
            }, { error ->
                callback(null, error)
            })
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun getReservedPositions(
            hopperId: String,
            callback: (List<HopperReserved>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetReservedPositionsRequest(hopperId).request<HopperAPIGetReservedPositionsResponse>(
                { data ->
                    callback(data.data, null)
                },
                { error ->
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionIds:  (required) Position Ids
        fun shortMultiplePositions(
            hopperId: String,
            positionIds: List<Int>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIShortMultiplePositionsRequest(
                hopperId,
                positionIds
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionId:  (required) Position Ids
        fun shortOnePosition(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIShortOnePositionRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        */
        ...
        /// - Parameter trailingBuy:  (required) Trailing Buy
        /// - Parameter trailingBuyPercentage:  (required) Trailing Buy Percentage
        fun activateDcaForMultiplePositions(
            hopperId: String,
            positionIds: List<Int>,
            marketOrder: Int,
            trailingBuy: Int,
            trailingBuyPercentage: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIActivateDCAForMultiplePositionsRequest(
                hopperId,
                positionIds,
                marketOrder,
                trailingBuy,
        ...
        fun activateDcaForOnePosition(
            ...
            HopperAPIActivateDCAForOnePositionRequest(
                hopperId,
                positionId,
                marketOrder,
                trailingBuy,
        ...
        fun moveOnePosition(
            ...
            HopperAPIMoveOnePositionsToReservedRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter positionId:  (required) Position Ids
        fun moveReservedPositionToOpen(
            hopperId: String,
            positionId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIMoveReservedPositionToOpenRequest(
                hopperId,
                positionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun getSignalsInHopper(
            hopperId: String,
            callback: (List<MarketSignal>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetSignalsInHopperRequest(hopperId).request<HopperAPIGetSignalsInHopperResponse>(
                { data ->
        ...
        fun getSignalById(
            hopperId: String,
            signalId: Int,
            callback: (MarketSignal?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetSignalByIdRequest(
                hopperId,
                signalId
            ).request<HopperAPIGetSignalByIdResponse>({ data ->
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter signalId:  (required) Signal Id
        fun subscribeToSignal(
            hopperId: String,
            signalId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPISubscribeToSignalRequest(
                hopperId,
                signalId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        /// - Parameter hopperId:  (required) Hopper Id
        /// - Parameter signalId:  (required) Signal Id
        fun unsubscribeFromSignal(
            hopperId: String,
            signalId: Int,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIUnsubscribeToSignalRequest(
                hopperId,
                signalId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun updateSignalConfig(
            hopperId: String,
            signalId: Int,
            config: Map<String, Any>,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIUpdateSignalConfigRequest(
                hopperId,
                signalId,
                config
            ).request<HopperCommonMessageResponse>({ data ->
        ...
        fun getDashboardStats(
            hopperId: String,
            callback: (HopperDashboardStats?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetHopperDashboardStatsRequest(hopperId).request<HopperAPIGetHopperDashboardStatsResponse>(
                { data ->
        ...
        fun getSubscription(
            hopperId: String,
            callback: (HopperSubscription?, HopperAPIError?) -> Unit
        ) {
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun reAssignSubscription(
            hopperId: String,
            subscriptionId: String,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIReassignSubsriptionRequest(
                hopperId,
                subscriptionId
            ).request<HopperCommonMessageResponse>({ data ->
                callback(data.data, null)
        ...
        fun updateConfig(
            hopperId: String,
            config: Map<String, Any>,
            callback: (HopperConfig?, HopperAPIError?) -> Unit
        ) {
            HopperAPIUpdateConfigRequest(
                hopperId,
                config
            ).request<HopperAPIUpdateConfigResponse>({ data ->
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun getAllConfigPools(
            hopperId: String,
            callback: (List<HopperConfigPool>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetAllConfigPoolsRequest(hopperId).request<HopperAPIGetAllConfigPoolsResponse>(
                { data ->
                    callback(data.data, null)
                },
                { error ->
        ...
        ///
        /// - Parameter hopperId:  (required) Hopper Id
        fun getOneConfigPools(
            hopperId: String,
            poolId: String,
            callback: (HopperConfigPool?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetOneConfigPoolRequest(
                hopperId,
                poolId
            ).request<HopperAPIGetOneConfigPoolResponse>({ data ->
                callback(data.data, null)
            }, { error ->
                callback(null, error)
            })
        ...
        fun createConfigPool(
            hopperId: String,
            enabled: HopperEnabled,
            configPool: HopperConfigPool,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPICreatePoolConfigRequest(
                hopperId,
                enabled,
                configPool
            ).request<HopperAPICreatePoolConfigResponse>({ data ->
        ...
        /// - Parameter enabled:  (required) Enabled with object HopperEnabled
        /// - Parameter configPool:  (required) Config Pool
        fun updateConfigPool(
            hopperId: String,
            enabled: HopperEnabled,
            configPool: HopperConfigPool,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIUpdateConfigPoolRequest(
                hopperId,
                enabled,
                configPool
            ).request<HopperCommonMessageResponse>({ data ->
        ...
        fun deleteConfigPool(
            hopperId: String,
            poolId: String,
            callback: (String?, HopperAPIError?) -> Unit
        ) {
            HopperAPIDeleteConfigPoolRequest(hopperId, poolId).request<HopperCommonMessageResponse>(
                { data ->
                    callback(data.data, null)
                },
                { error ->
        ...
        fun getTradeHistory(
            ...
            dateFrom: String?,
            count: Int?,
            callback: (List<HopperTradeHistory>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetTradeHistoryRequest(
                hopperId,
                dateFrom,
                count
            ).request<HopperAPIGetTradeHistoryResponse>({ data ->
        ...
        fun getTradeHistory(
            ...
            HopperAPIGetTradeHistoryByIdRequest(
                hopperId,
                tradeId
            ).request<HopperAPIGetTradeHistoryByIdResponse>({ data ->
                callback(data.data, null)
            }, { error ->
                callback(null, error)
            })
        ...
        fun getOutput(
            ...
            dateFrom: Date,
            dateTo: Date,
            entryType: HopperSearchOptionsItemEntry,
            sortField: HopperSearchOptionsItemSortField,
            sortOrder: HopperSearchOptionsItemSortOrder,
            page: Int,
            perPage: Int,
            callback: (List<HopperOutput>?, HopperAPIError?) -> Unit
        ) {
            HopperAPIGetOutputRequest(
                hopperId,
                dateFrom,
                dateTo,
                entryType,
                ...
                page,
                perPage
            ).request<HopperAPIGetOutputResponse>({ data ->
                callback(data.data, null)
            }, { error ->
                callback(null, error)
            })
