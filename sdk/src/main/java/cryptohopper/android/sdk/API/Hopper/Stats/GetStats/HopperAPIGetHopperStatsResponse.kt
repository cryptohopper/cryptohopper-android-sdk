...
data class HopperStats (
        ...
        @SerializedName("buysandsells") val buysSells: Any?,
        ...
        @SerializedName("allocation_of_funds") val allocationOfFunds: Map<String,Any>?,
        @SerializedName("currentinassets") val currentInAssets: List<List<Any>>?,
        @SerializedName("currentusdinassets") val currentUsdInAssets: List<List<Any>>?,
...
data class HopperStatsOpenPosition (
        ...
        @SerializedName("average_perc") val averagePercentage: Any?,
